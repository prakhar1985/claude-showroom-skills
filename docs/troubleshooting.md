...
nav_order: 5
description: "Common issues and solutions for Showroom Skills"
---
...
See [SKILL.md frontmatter formatting](#2-skillmd-frontmatter-formatting-issue) above.
...
- [GitHub Issues - claude-showroom-skills](https://github.com/psrivast/claude-showroom-skills/issues)
- [GitHub Issues - showroom-template-nookbag](https://github.com/rhpds/showroom-template-nookbag/issues)
...
2. **Create issue** at [GitHub Issues](https://github.com/psrivast/claude-showroom-skills/issues/new)
...
| **Structure** | Learning objectives + exercises | Know/Show (business + technical) |
| **Verification** | Mandatory checkpoints | Optional |
| **Focus** | Skill building | Business value |
| **Duration** | 30-45 min per module | 10-15 min per module |
...
- [Verify Content](skills/verify-content) - Validation skill documentation
- [Create Lab](skills/create-lab) - Workshop creation skill
- [Create Demo](skills/create-demo) - Demo creation skill
