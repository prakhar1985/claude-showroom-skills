...
See link:setup.html#option-c-advanced-users-existing-configuration[Setup Guide - Option C] for instructions on merging Showroom skills with your existing settings, custom skills, and prompts without overwriting.
====
